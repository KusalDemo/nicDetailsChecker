...
export function NicDetailCheckerCard() {
    ...
    return (
        <Card sx={{width : {xs: 300, sm: 400, md: 500, lg: 500}}} elevation={10} >
            <CardMedia sx={{ height: 210 }} image="https://images.examples.com/wp-content/uploads/2019/08/association-id-card-feature.jpg"/>
            <CardContent>
                <div id="inputDiv" style={{display: "flex", flexDirection: "column", gap: "20px", margin: "20px 10px"}}>
                    ...
                    <div>
                        <p style={{color: "green", fontWeight: "bold"}}>Birthday : </p>
                        <h4 id="txtBirthday">{birthday}</h4>
                    </div>
                    <div>
                        <p style={{color: "green", fontWeight: "bold"}}>Gender : </p>
